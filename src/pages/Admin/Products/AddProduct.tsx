...
const AddProduct: React.FC = () => {
    ...
    // Image states
    const [images, setImages] = useState<string[]>([]); // Base64 strings for simplicity
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.data.success) {
                toast.success('Product completely added!');
    ...
    return (
        <div className="admin-page-container position-relative">
            <div className="page-header d-flex align-items-center mb-4">
                ...
                <h1 className="page-title m-0">Add New Product</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="row">
                        ...
                        <div className="row">
                            <div className="col-md-6 mb-4">
                                ...
                                <input
                                    ...
                                    min="1"
                                    className="form-control admin-input"
                                    placeholder="E.g., 50 (Positive Only)"
                                    value={quantity}
                ...
                <div className="col-lg-4">
                    ...
                    <div className="admin-card" style={{ padding: '24px' }}>
                        <button type="submit" disabled={loading} className="btn w-100 d-flex align-items-center justify-content-center" style={{ backgroundColor: 'var(--admin-primary-dark)', color: '#fff', borderRadius: '8px', padding: '12px', fontWeight: 600 }}>
                            {loading ? 'Saving...' : <><Save size={18} className="me-2" /> Save Product</>}
                        </button>
                    </div>
                </div>
            </form>
